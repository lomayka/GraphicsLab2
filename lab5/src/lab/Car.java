...
public class Car extends JFrame {
    ...
    private void addImageBackground() {
        TextureLoader t = new TextureLoader("source_folder/track.jpg", canvas);
    ...
    private TransformGroup getCarGroup() throws IOException {
        Shape3D shape = getModelShape3D("car", "source_folder/car/Long_Car.obj");
    ...
    public static void main(String[] args) {
        try {
            Car window = new Car();
            CarAnimation carMovement = new CarAnimation(car);
